...
public class ProductdetailAdapter extends RecyclerView.Adapter<ProductdetailAdapter.MyViewHolder> {
    ...
    List<BasketModel> datumArrayList;

    public ProductdetailAdapter(Context context, List<BasketModel> datumArrayList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int position) {
        final BasketModel data = datumArrayList.get(position);
        ...
        try {
            ...
            myViewHolder.txtproductPrice.setText(data.getPrice().toString());
            myViewHolder.txtpurchaseqty.setText(" " + data.getAddedQuantity());
        }catch (Exception e)
        {
            e.printStackTrace();
        }
