...
public class RedeemQrAdapter extends LoadMoreRecyclerAdapter<RedeemQrAdapter.MyViewHolder, Datum> {

    private Context context;
    private OnItemClickLister onItemClickLister = null;


    public RedeemQrAdapter(Context activity, List<Datum> datumList) {
        super(datumList);
    ...
    public class MyViewHolder extends BaseRecyclerAdapter<RedeemQrAdapter.MyViewHolder, Datum>.ViewHolder implements View.OnClickListener {
