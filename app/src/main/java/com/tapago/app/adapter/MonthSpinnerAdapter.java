...
public class MonthSpinnerAdapter extends BaseAdapter {
    ...
    private List<MonthModel> stringList;

    public MonthSpinnerAdapter(Activity activity, List<MonthModel> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position > 0) {
            monthModel = stringList.get(position - 1);
        }
        ...
        if (position == 0) {
            tvCatName.setText(R.string.select_month);
            ...
            if (monthModel != null)
                tvCatName.setText(monthModel.getMonth());
