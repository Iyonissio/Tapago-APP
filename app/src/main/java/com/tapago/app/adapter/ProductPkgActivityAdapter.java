...
public class ProductPkgActivityAdapter extends RecyclerView.Adapter<ProductPkgActivityAdapter.MyViewHolder> {
    ...
    public ProductPkgActivityAdapter(Context activity, ProductDetailActivity productDetailActivity, String selectedPkg, List<ProductSize> productSizeist) {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, final int i) {
        ...
        myViewHolder.lrmain.setOnClickListener(new View.OnClickListener() {
            ...
            //    productCategoryListAdapter.setPkgQty(position, data.getProductScale(),data.getProductWeight().toString(),data.getPrice().toString());
                productDetailActivity.setPkgQty(data.getProductScale(),data.getProductWeight().toString(),data.getPrice().toString());
            }
        });
    }
