                        ...
                        if (grantResults[i] == PackageManager.PERMISSION_DENIED) {
                            ...
                            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
                                ...
                                if (!showRationale) {
                                    ...
                                    new AlertDialog.Builder(ScannerActivity.this).setMessage("Please Approve Camera Permission to use this app")
    ...
    public void scanQrCodeApi(String voucherCode, String paymentType, String eventId) {
        if (AppUtils.isConnectedToInternet(getActivity())) {
            ...
            if (eventId.length() > 0) {
                ...
                params.put("event_id", MySharedPreferences.getMySharedPreferences().getEventId());
            }
            params.put("select_event_id", MySharedPreferences.getMySharedPreferences().getEventId());
