package com.tapago.app.model.MyEventModel;
...
public class Datum {
    ...
    @SerializedName("event_purchase_status")
    @Expose
    private String eventPurchase;
    ...
    public String getEventPurchase() {
        return eventPurchase;
    }

    public void setEventPurchase(String eventPurchase) {
